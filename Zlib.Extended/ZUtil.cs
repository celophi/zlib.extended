...
namespace Zlib.Extended
{
    public static class Zutil
    {
        ...
        /// <summary>
        /// Mapping between return code enumeration and error message.
        /// </summary>
        public static readonly IReadOnlyDictionary<ReturnCode, string> ErrorMessages = new Dictionary<ReturnCode, string>()
        {
            { ReturnCode.Z_NEED_DICT, "need dictionary" },
            { ReturnCode.Z_STREAM_END, "stream end" },
            { ReturnCode.Z_OK, string.Empty },
            { ReturnCode.Z_ERRNO, "file error" },
            { ReturnCode.Z_STREAM_ERROR, "stream error" },
            { ReturnCode.Z_DATA_ERROR, "data error" },
            { ReturnCode.Z_MEM_ERROR, "insufficient memory" },
            { ReturnCode.Z_BUF_ERROR, "buffer error" },
            { ReturnCode.Z_VERSION_ERROR, "incompatible version" },
        };
